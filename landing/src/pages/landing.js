...
import ApplyForm from 'containers/CryptoModern/ApplyForm';
...
const CryptoModern = () => {
  return (
    <ThemeProvider theme={theme}>
      <>
        <Head>
          <title>Borderless | Guide into the Metaverse</title>
          <meta name="Description" content="Guide into the Metaverse" />
